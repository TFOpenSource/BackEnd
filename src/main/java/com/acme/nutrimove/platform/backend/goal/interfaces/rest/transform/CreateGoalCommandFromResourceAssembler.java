...
public class CreateGoalCommandFromResourceAssembler {
    ...
    public static CreateGoalCommand toCommand(CreateGoalResource resource) {
        return new CreateGoalCommand(resource.goal_type(), resource.start_date(), resource.end_date(), resource.userId());
    }
}
