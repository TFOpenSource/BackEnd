package com.acme.nutrimove.platform.activities.domain.model.commands;


public record CreateActivityCommand(String name, String description, Integer duration,
                                    Long user_id) {
